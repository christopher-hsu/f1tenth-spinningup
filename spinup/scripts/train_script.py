...
def main():
    ...
    #     logger_kwargs = dict(output_dir='data/ppo/'+exp_name, exp_name=exp_name)
    #     ppo(env_fn=env_fn, ac_kwargs=ac_kwargs, steps_per_epoch=5000, epochs=args.epochs, 
    ...
    #     sac(env_fn=env_fn, ac_kwargs=ac_kwargs, steps_per_epoch=5000, epochs=args.epochs, 
    #         logger_kwargs=logger_kwargs, save_freq=args.checkpoint_freq)
